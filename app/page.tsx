...
export default function HomePage() {
  ...
  return (
    <div>
      <section className="page-width grid items-center gap-0 py-8 md:grid-cols-2 md:py-9">
        ...
        <div className="py-8 md:px-10">
          <h1 className="text-[34px] leading-[1.15] md:text-[42px]">
            {site.tagline}
          </h1>
          ...
          <Link
            href="/collections/kids-nameboards"
            className="dawn-btn mt-7"
          >
            Customise Yours
          </Link>
        </div>
      ...
      <section className="bg-[#e8ddd4]">
        <div className="page-width py-9">
          <h2 className="text-[34px] leading-tight md:text-[40px]">
      ...
      <section className="page-width py-10">
        <h2 className="mb-8 text-[34px] leading-tight md:text-[40px]">
          Most Loved !
        </h2>
        ...
        <div className="grid grid-cols-2 gap-5 md:grid-cols-3">
          {categories.map((c) => (
            <Link key={c.handle} href={`/collections/${c.handle}`} className="group">
              ...
              <p className="mt-1 line-clamp-2 text-[13px] text-[#4a403a]">
                {c.description}
      ...
      <section className="page-width grid items-center gap-8 py-10 md:grid-cols-[0.9fr_1.1fr]">
        <div className="relative mx-auto aspect-square w-full max-w-sm overflow-hidden bg-[#f7f3ee]">
          <Image
        ...
        <div className="text-center md:px-6">
          <h2 className="text-[36px] leading-tight md:text-[42px]">
            Painted by hand. By me
          </h2>
      ...
      <section className="page-width grid items-center gap-8 py-10 md:grid-cols-[0.9fr_1.1fr]">
        <div className="relative mx-auto aspect-[3/4] w-full max-w-sm overflow-hidden bg-[#f7f3ee]">
          <Image
