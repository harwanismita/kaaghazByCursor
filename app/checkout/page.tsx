...
export default function CheckoutPage() {
  const { items, subtotal, shipping, discount, total, couponApplied, clear } =
    useCart();
  ...
  function onSubmit(e: FormEvent) {
    ...
    const url = `https://wa.me/91${site.phone}?text=${text}`;
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-3 max-w-xl text-sm leading-6 text-[#4a403a]">
        This free site does not charge Shopify fees. Your order opens on
        WhatsApp to {site.phone}. Smita confirms the piece, then you pay by
        UPI, card, or bank transfer — same as before, without the ₹2,000/month
        store bill.
      </p>
